...
settings = {
    ...
    "simulation_name": datetime.now().strftime('%Y%m%d_%H%M_file1_30000_45000'),
    ...
    "partial_data_start": 30000, # Start of the range of partial data to use
    "partial_data_end": 45000, # End of the range of partial data to use
