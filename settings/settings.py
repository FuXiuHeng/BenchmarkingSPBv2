...
settings = {
    ...
    "simulation_name": datetime.now().strftime('%Y%m%d_%H%M_file1_28259_30000'),
    ...
    "partial_data_start": 28259, # Start of the range of partial data to use
    "partial_data_end": 30000, # End of the range of partial data to use
